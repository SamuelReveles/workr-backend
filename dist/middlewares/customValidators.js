...
exports.contactLinksValidator = contactLinksValidator;
exports.experienceValidator = experienceValidator;
exports.skillsValidator = skillsValidator;
exports.educationValidator = educationValidator;
exports.newHiresValidator = newHiresValidator;
function contactLinksValidator(value) {
...
function experienceValidator(value) {
...
function skillsValidator(value) {
...
function educationValidator(value) {
...
function newHiresValidator(value) {
 ...
 */
function validateJSONArray(data, fieldName) {
 ...
 */
function throwItemFieldError(field, index, subfield) {
