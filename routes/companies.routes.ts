...
import { companyCharts, createPaymentIntent, getCompanyPayInfo, getCompanyProfile, getProfilePicture, registerCompany, updateCompanyProfile } from "../controllers/companies.controller";
